...
start_btn.onclick = ()=>{
    ...
    start_btn.classList.add("removebtn"); //hide start button
}

// if exitQuiz button clicked
exit_btn.onclick = ()=>{
    info_box.classList.remove("activeInfo"); //hide info box
    start_btn.classList.remove("removebtn"); //show start button
}
...
quit_quiz.onclick = ()=>{
    window.location.assign("https://nangzzz.github.io/kuis-indonesia/"); //back to homepage
}
